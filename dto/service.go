...
type ServiceListOutput struct {
	...
	List  []ServiceListItemOutput `json:"list" form:"list" comment:"数据" example:"" validate:""`   //列表
}

type ServiceAddHTTPInput struct {
	ServiceName string `json:"service_name" form:"service_name" comment:"服务名称" example:"" validate:"required,is_valid_service_name"` //服务名称
	...
	Rule        string `json:"rule" form:"rule" comment:"接入路径:域名或者前缀" example:"" validate:"required,is_valid_rule"`          //接入路径
	...
	UpstreamConnectTimeout int `json:"upstream_connect_timeout" form:"upstream_connect_timeout" comment:"建立连接超时：单位秒" example:"" validate:"min=0"`   //建立连接超时：单位秒
	UpstreamHeaderTimeout  int `json:"upstream_header_timeout" form:"upstream_header_timeout" comment:"获取header超时：单位秒" example:"" validate:"min=0"` //获取header超时：单位秒
	UpstreamIdleTimeout    int `json:"upstream_idle_timeout" form:"upstream_idle_timeout" comment:"连接最大空闲时间：单位秒" example:"" validate:"min=0"`       //连接最大空闲时间
	UpstreamMaxIdle        int `json:"upstream_max_idle" form:"upstream_max_idle" comment:"最大空间连接数" example:"" validate:"min=0"`                    //最大空间连接数
}
...
type ServiceUpdateHTTPInput struct {
	ID int64 `json:"id" form:"id" comment:"服务id" example:"71" validate:"required,min=1"` //服务id
	ServiceName string `json:"service_name" form:"service_name" comment:"服务名称" example:"test_serive_indb" validate:"required,is_valid_service_name"` //服务名称
	ServiceDesc string `json:"service_desc" form:"service_desc" comment:"服务描述" example:"test_serive_indb" validate:"required,max=255,min=1"` //服务描述
	RuleType    int `json:"rule_type" form:"rule_type" comment:"接入类型" example:"" validate:"max=1,min=0"` //接入类型
	Rule        string `json:"rule" form:"rule" comment:"接入路径:域名或者前缀" example:"/test_serive_indb" validate:"required,is_valid_rule"`          //接入路径
